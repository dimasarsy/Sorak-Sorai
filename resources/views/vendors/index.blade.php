                ...
                <div class="myLeftCtn-vendor">
                    ...
                    <form action="{{ url('pengajuan/store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-4">
                            <input id="marketplace_link" placeholder="Link Marketplace" name="marketplace_link" type="marketplace_link" autofocus class="myInput" value="{{ old('marketplace_link') }}" required>
                            @error('marketplace_link')<div class="small-text">{{ $message }}</div>@enderror
                        </div>
