       ...
       <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background: linear-gradient(180deg, #080036, #670097 100%);">
          ...
          @can('admin')
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('dashboard/admins*') ? 'active' : '' }} && {{ Request::is('dashboard/users*')  ? 'active' : '' }} && {{ Request::is('dashboard/vendors*')  ? 'active' : '' }}  collapsed" href="#" data-toggle="collapse" data-target="#collapsePages"
          ...
          @can('admin')
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('dashboard/addSchedule*') ? 'active' : '' }} && {{ Request::is('dashboard/scheduleHistory*')  ? 'active' : '' }} && {{ Request::is('dashboard/orders*')  ? 'active' : '' }} collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
