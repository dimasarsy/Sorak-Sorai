...
<section class="login">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
        <div class="section-login">
            <h3 class="login" data-aos="fade-left">Masuk</h3>
        </div>
    </div>
                ...
                <div class="myLeftCtn">
                    ...
                    <form class="myForm text-center" action="/login" method="POST" novalidate>
                        ...
                        <div class="form-group" >
                            ...
                            <input id="email" placeholder="Email" name="email" type="email" autofocus class="myInput" value="{{ old('email') }}" required>
                            @error('email')<div class="small-text">{{ $message }}</div>@enderror
                        </div>

                        <div class="form-group">
                            <i class="fas fa-lock"></i>
                            <input id="password" name="password" type="password" placeholder="Kata Sandi" class="myInput" required>
                            @error('password')<div class="small-text">{{ $message }}</div>@enderror
                        </div>

                        <input type="submit" class="butt" value="LOGIN">

                        <p>Belum punya akun? <a href="/register">Daftar Akun </a></p>
